...
const i18n = {
  en: {
    ...
    "cap.h2": "Built for Arabic-first audiences",
    "cap.p": "Fonts, spacing, and layout balance are tuned for both RTL and LTR reading.",
    "cap.f1t": "Guided navigation",
    "cap.f1p": "Sticky header, smooth anchors, and clear CTAs keep users on track on any device.",
    "cap.f2t": "Logo-first header",
    "cap.f2p": "Drop your logo into the reserved slot and keep the brand visible across breakpoints.",
    "cap.f3t": "Readable Arabic",
    "cap.f3p": "RTL-aware grids, line heights, and alignment keep Arabic copy crisp on mobile.",
  ...
  ar: {
    ...
    "cap.h2": "مصمم للجمهور العربي أولاً",
    "cap.p": "الخطوط والمسافات والهيكل متوازنة للقراءة بالاتجاهين.",
    "cap.f1t": "تنقل موجه",
    "cap.f1p": "ترويسة ثابتة وروابط سلسة تحافظ على وضوح الدعوات للعمل على كل الأجهزة.",
    "cap.f2t": "ترويسة تركّز على الشعار",
    "cap.f2p": "ضع شعارك في المكان المخصص ليبقى ظاهرًا عبر كل المقاسات.",
    "cap.f3t": "عربية سهلة القراءة",
    "cap.f3p": "شبكات تدعم RTL مع ارتفاع أسطر ومحاذاة تجعل النص العربي واضحًا على الجوال.",
  ...
  zh: {
    ...
    "cap.h2": "为中文/阿语读者调优",
    "cap.p": "字体、留白与布局同时兼容 RTL 与 LTR 阅读体验。",
    "cap.f1t": "引导式导航",
    "cap.f1p": "粘性导航、顺滑跳转与清晰 CTA，适配所有设备。",
    "cap.f2t": "Logo 优先的页眉",
    "cap.f2p": "在保留的插槽放入标志，跨断点都能醒目展示。",
    "cap.f3t": "易读的阿语",
    "cap.f3p": "RTL 网格、行距与对齐方式，确保阿语文本在手机上清晰可读。",
